...
class Backtesting:
    ...
    def test_algorithm(self):
        ...
        print("FINAL: {}".format(self.ta.profit))
        return self.ta.profit

    def stock_info_generator(self, date_dict):
        # TODO - Make sure the dates are being generated in reverse order
        data_up_to_date = {}
        for count, day in enumerate(reversed(date_dict)):
    ...
    def filter_dates(self, date_dict):
        ...
        if not date_dict:
            ...
            return {}
        for date in reversed(date_dict):
...
if __name__ == '__main__':
    historical_test = Backtesting(test_tickers=["RNG"], start_date="2020-04-03", end_date="2020-07-07")
